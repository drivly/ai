        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            {status === 'loading' ? (
              ...
              <SidebarMenuButton data-testid='user-nav-button' className='data-[state=open]:bg-sidebar-accent bg-background data-[state=open]:text-sidebar-accent-foreground h-10'>
