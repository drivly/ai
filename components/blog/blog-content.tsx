...
export function BlogContent() {
  return (
    <div className="prose prose-lg dark:prose-invert max-w-none">
      ...
      <p>
        AI is powerful—but as any developer knows, integrating it into real applications is often frustrating. You get
        brittle outputs, endless prompt tweaking, and unexpected failures. That's where <strong>Functions.do</strong>{" "}
        comes in.
      </p>
      <p>
        Functions.do transforms generative AI into <strong>structured, predictable functions</strong>—like building
        blocks you can trust. No more parsing vague responses. No more wrapping fragile prompts. Just clean, reliable,
        strongly-typed outputs you can plug directly into your app.
      </p>
