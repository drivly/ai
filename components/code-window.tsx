...
export function CodeWindow({ className, code, language = "json", title = "llm.do" }: CodeWindowProps) {
  ...
  return (
    <div className={cn("rounded-2xl border-[10px] border-white/10 bg-white bg-opacity-[0.01]", className)}>
      <div className="relative w-full overflow-hidden rounded-md border">
        ...
        {/* Code content */}
        <div className="max-h-[500px] overflow-auto bg-black/90 p-4 font-mono text-sm text-white text-left px-8">
