...
export const Social = () => {
  ...
  const handleOAuthLogin = (provider: SocialProvider) => {
  ...
  return (
    <div className='flex w-full flex-col items-center justify-between gap-[8px]'>
      <button
        type='button'
        className='flex h-[40px] w-full cursor-pointer items-center justify-center gap-[8px] rounded-md border px-4 py-2 text-[14px] leading-[22px]'
        disabled={isPending}
