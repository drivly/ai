...
export const siteCategories: Record<string, string[]> = {
  ...
  'Assistants': ['amy.do', 'ivy.do', 'lena.do', 'lexi.do'],
...
export const domainDescriptions: Record<string, string> = {
  ...
  'cfo.do': 'CFO - Financial Planning and Analysis',
  'clickhouse.do': 'High-Performance Analytics Database',
  'cmo.do': 'CMO - Marketing Strategy and Execution',
  'colo.do': 'Colocation and Infrastructure',
  'coo.do': 'COO - Operations Management',
  'cpo.do': 'CPO - Product Strategy and Roadmap',
  'cro.do': 'CRO - Revenue Optimization',
  'cto.do': 'CTO - Technology Strategy and Leadership',
  ...
  'nat.do': 'NAT - Network Address Translation',
