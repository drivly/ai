...
async function generateConstants() {
  try {
    ...
    const triggerNames = ['webhookReceived', 'scheduleTriggered', 'eventOccurred', 'dataChanged', 'userAction']
...
`
    ...
    const actionNames = ['sendEmail', 'createRecord', 'updateRecord', 'deleteRecord', 'processData']
...
`
    ...
    const searchNames = ['textSearch', 'vectorSearch', 'hybridSearch', 'metadataSearch', 'semanticSearch']
