  ...
  return (
    <div className={cn('flex flex-wrap items-center gap-px font-mono text-xs text-zinc-500 dark:text-zinc-500', className)}>
      ...
      <button
        ...
        className='ml-1 flex h-4 w-4 cursor-pointer items-center justify-center text-zinc-500 transition-colors hover:text-zinc-700 disabled:cursor-not-allowed disabled:opacity-50 dark:text-zinc-500 dark:hover:text-zinc-300'>
