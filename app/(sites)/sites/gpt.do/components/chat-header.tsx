...
export function ChatHeader({ chatId, selectedModelOption, setSelectedModelOption, selectedVisibilityType, isReadonly, modelOptions, tool, output, setQueryState }: ChatHeaderProps) {
