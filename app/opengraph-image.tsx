...
// was under app/(sites)/sites/[domain]/opengraph-image.tsx
...
//   const content = await getContent(params.domain)
//   const [title, subtitle] = content.seo.title.split(' - ') || ['Business-as-Code', 'dotdo.ai']
