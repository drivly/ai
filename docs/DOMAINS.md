...
| ------------ | ---------- | ------------------------------------------------ | -------------------------------------------- | ----------- |
| databases.do | ✅ Online  | ernest.ns.cloudflare.com, gina.ns.cloudflare.com | [https://databases.do](https://databases.do) | database.do |
| okrs.do      | ❌ Offline | dayana.ns.cloudflare.com, sean.ns.cloudflare.com | [https://okrs.do](https://okrs.do)           | goals.do    |
...
| Domain         | Status     | NS Records                                                   | Link                                             |
| -------------- | ---------- | ------------------------------------------------------------ | ------------------------------------------------ |
| action.do      | ❌ Offline | dayana.ns.cloudflare.com, sean.ns.cloudflare.com             | [https://action.do](https://action.do)           |
...
| bdr.do         | ❌ Offline | dayana.ns.cloudflare.com, sean.ns.cloudflare.com             | [https://bdr.do](https://bdr.do)                 |
| benchmarks.do  | ❌ Offline | dayana.ns.cloudflare.com, sean.ns.cloudflare.com             | [https://benchmarks.do](https://benchmarks.do)   |
...
| browser.do     | ✅ Online  | dayana.ns.cloudflare.com, sean.ns.cloudflare.com             | [https://browser.do](https://browser.do)         |
| browsers.do    | ❌ Offline | dayana.ns.cloudflare.com, sean.ns.cloudflare.com             | [https://browsers.do](https://browsers.do)       |
| careers.do     | ✅ Online  | ernest.ns.cloudflare.com, gina.ns.cloudflare.com             | [https://careers.do](https://careers.do)         |
| cfo.do         | ❌ Offline | dayana.ns.cloudflare.com, sean.ns.cloudflare.com             | [https://cfo.do](https://cfo.do)                 |
...
| coach.do       | ❌ Offline | dayana.ns.cloudflare.com, sean.ns.cloudflare.com             | [https://coach.do](https://coach.do)             |
| colo.do        | ✅ Online  | dayana.ns.cloudflare.com, sean.ns.cloudflare.com             | [https://colo.do](https://colo.do)               |
| context.do     | ❌ Offline | ernest.ns.cloudflare.com, gina.ns.cloudflare.com             | [https://context.do](https://context.do)         |
| coo.do         | ❌ Offline | dayana.ns.cloudflare.com, sean.ns.cloudflare.com             | [https://coo.do](https://coo.do)                 |
| cpo.do         | ❌ Offline | None found                                                   | [https://cpo.do](https://cpo.do)                 |
| cro.do         | ❌ Offline | dayana.ns.cloudflare.com, sean.ns.cloudflare.com             | [https://cro.do](https://cro.do)                 |
| cto.do         | ❌ Offline | dns2.midominio.do, dns3.midominio.do, dns1.midominio.do, dns4.midominio.do | [https://cto.do](https://cto.do)                 |
| ctx.do         | ✅ Online  | ernest.ns.cloudflare.com, gina.ns.cloudflare.com             | [https://ctx.do](https://ctx.do)                 |
| dara.do        | ❌ Offline | dayana.ns.cloudflare.com, sean.ns.cloudflare.com             | [https://dara.do](https://dara.do)               |
| dash.do        | ❌ Offline | dns1.midominio.do, dns3.midominio.do, dns2.midominio.do, dns4.midominio.do | [https://dash.do](https://dash.do)               |
| dashboard.do   | ❌ Offline | None found                                                   | [https://dashboard.do](https://dashboard.do)     |
| do.com.ai      | ✅ Online  | ns1.vercel-dns.com, ns2.vercel-dns.com                       | [https://do.com.ai](https://do.com.ai)           |
| emails.do      | ✅ Online  | dayana.ns.cloudflare.com, sean.ns.cloudflare.com             | [https://emails.do](https://emails.do)           |
| embeddings.do  | ❌ Offline | None found                                                   | [https://embeddings.do](https://embeddings.do)   |
| esbuild.do     | ✅ Online  | ernest.ns.cloudflare.com, gina.ns.cloudflare.com             | [https://esbuild.do](https://esbuild.do)         |
