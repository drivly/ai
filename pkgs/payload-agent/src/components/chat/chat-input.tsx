import { Button, PromptInput, PromptInputAction, PromptInputActions, PromptInputTextarea } from '@drivly/ui/components'
      ...
      <form className='font-geist border-border bg-background border-t dark:bg-black'>
        ...
        <PromptInput
          ...
          <PromptInputTextarea
            ...
            className='placeholder:text-muted-foreground font-geist px-4 py-3 text-[14px] leading-[24px] placeholder:text-[14px] focus:outline-none md:text-[14px]'
