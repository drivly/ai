...
A [Workflow](/docs/workflows) is a special type of [Function](/docs/functions) defined as declarative [Code](/docs/functions#code) that enables [AI](/docs/functions#agents) and [Humans](/docs/functions#humans) to work together to accomplish business [Tasks](/docs/business/tasks) in the pursuit of a [Goal](/docs/business/goals) as measured by [KPIs](/docs/business/kpis).
