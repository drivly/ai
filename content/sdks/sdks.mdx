...
#### `addCollectionToPackage(packageId: string, collectionType: string): Promise<any>`

Add a collection to a package.

#### `removeCollectionFromPackage(packageId: string, collectionType: string): Promise<any>`
...
#### `addCollection(packageId: string, collectionType: string): Promise<any>`

Add a collection to a package.

#### `removeCollection(packageId: string, collectionType: string): Promise<any>`
