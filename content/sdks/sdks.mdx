...
#### `addCollectionToPackage(packageId: string, collectionName: string): Promise<any>`

Add a collection to a package.

#### `removeCollectionFromPackage(packageId: string, collectionName: string): Promise<any>`
...
#### `addCollection(packageId: string, collectionName: string): Promise<any>`

Add a collection to a package.

#### `removeCollection(packageId: string, collectionName: string): Promise<any>`
