...
Vector search enables semantic search capabilities for the Things collection in the Drivly AI platform.

## Overview

The vector search implementation allows for finding relevant Things based on meaning rather than just keyword matching, using OpenAI embeddings.
