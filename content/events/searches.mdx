...
Searches allow you to query and retrieve data from various sources in your AI applications.

## Overview

The Searches collection provides a powerful way to define, manage, and execute search operations across your data. Searches can:
...
- **Semantic Understanding**: Find results based on meaning, not just keywords
- **Filtering**: Apply complex filters to narrow down results
- **Ranking**: Sort results by relevance or other criteria
...
- [Create your first search](/events/searches/create)
- [Explore search templates](/events/searches/templates)
- [Learn about semantic search](/events/searches/semantic)