...
Nouns represent categories or types of resources in your system - the fundamental building blocks of your business domain model. In English grammar terms, nouns are the "person, place, resource, or idea" that can perform actions or have actions performed on them.
