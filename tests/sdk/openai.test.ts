...
describe('OpenRouter Privacy and Logging', () => {
  test.fails('can create a chat completion with privacy enabled', async () => {
    const response = await client.chat.completions.create({
      model: models[0],
      messages: [{ role: 'user', content: 'Hello, world!' }],
...
describe('OpenRouter Model Routing', () => {
  test.fails('can route to specific models by name', async () => {
    const response = await client.chat.completions.create({
      model: models[0],
      messages: [{ role: 'user', content: 'Hello, world!' }],
  ...
  test.fails('can route to models by capability', async () => {
    const response = await client.chat.completions.create({
...
describe('OpenRouter Provider Routing', () => {
  test.fails('can route to providers by sorting by price', async () => {
    const response = await client.chat.completions.create({
      model: models[0],
      messages: [{ role: 'user', content: 'Hello, world!' }],
      // @ts-expect-error OpenAI SDK does not support provider
  ...
  test.fails('can route to specific providers', async () => {
    const response = await client.chat.completions.create({
      model: models[0],
      messages: [{ role: 'user', content: 'Hello, world!' }],
      // @ts-expect-error OpenAI SDK does not support provider
  ...
  test.fails('can route with fallback providers', async () => {
    const response = await client.chat.completions.create({
      model: models[0],
      messages: [{ role: 'user', content: 'Hello, world!' }],
      // @ts-expect-error OpenAI SDK does not support provider
...
describe('OpenRouter Prompt Caching', () => {
  test.fails('can create a chat completion with caching enabled', async () => {
  ...
  test.fails('can create a chat completion with cache invalidation', async () => {
    const response = await client.chat.completions.create({
      model: models[0],
...
describe('OpenRouter Structured Outputs', () => {
  test.fails('can create a chat completion with JSON schema', async () => {
    const response = await client.chat.completions.create({
      model: models[0],
...
describe('OpenRouter Tool Calling', () => {
  test.fails('can create a chat completion with tool calling', async () => {
    const response = await client.chat.completions.create({
      model: models[0],
      messages: [{ 
        role: 'user', 
...
describe('OpenRouter Images & PDFs', () => {
  ...
  test.fails('can create a chat completion with image input', async () => {
    const response = await client.chat.completions.create({
...
describe('OpenRouter Message Transforms', () => {
  test.fails('can create a chat completion with message transforms', async () => {
    const response = await client.chat.completions.create({
      model: models[0],
      messages: [{ role: 'user', content: 'Hello, world!' }],
...
describe('OpenRouter Uptime Optimization', () => {
  test.fails('can create a chat completion with uptime optimization', async () => {
    const response = await client.chat.completions.create({
      model: models[0],
      messages: [{ role: 'user', content: 'Hello, world!' }],
...
describe('OpenRouter Web Search', () => {
  test.fails('can create a chat completion with web search', async () => {
    const response = await client.chat.completions.create({
...
describe('OpenRouter Zero Completion Insurance', () => {
  test.fails('can create a chat completion with zero completion insurance', async () => {
    const response = await client.chat.completions.create({
      model: models[0],
      messages: [{ role: 'user', content: 'Hello, world!' }],
...
describe('OpenRouter Provisioning API Keys', () => {
  test.fails('can provision API keys for providers', async () => {
  ...
  test.fails('can list provisioned API keys', async () => {
