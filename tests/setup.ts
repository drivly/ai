...
process.env.BASE_URL = baseUrl.startsWith('http') ? baseUrl : `http://${baseUrl}`
process.env.BASE_URL = process.env.BASE_URL.endsWith('/') ? process.env.BASE_URL : `${process.env.BASE_URL}/`
